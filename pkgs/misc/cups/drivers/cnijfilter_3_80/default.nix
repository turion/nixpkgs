...
in stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      url = "https://raw.githubusercontent.com/tokiclover/bar-overlay/7a7b78aa96fdc68a97ac6227ddf8e5d079cf9c19/net-print/cnijfilter/files/cnijfilter-3.80-1-cups-1.6.patch";
      name = "cnijfilter-3.80-1-cups-1.6.patch";
      sha256 = "0sv5ixxa72dhm86shfbaidiyxx3cm6a5wsi6nklpmjf5fz621gwy";
    })
    (fetchpatch {
      url = "https://raw.githubusercontent.com/tokiclover/bar-overlay/7a7b78aa96fdc68a97ac6227ddf8e5d079cf9c19/net-print/cnijfilter/files/cnijfilter-3.80-6-cups-1.6.patch";
      name = "cnijfilter-3.80-6-cups-1.6.patch";
      sha256 = "09l9zq6l0xnb2nbf9yrnkhhl218ja0kid8bqfjjqvqj5d9lb7pd4";
    })
    (fetchpatch {
      url = "https://raw.githubusercontent.com/tokiclover/bar-overlay/7a7b78aa96fdc68a97ac6227ddf8e5d079cf9c19/net-print/cnijfilter/files/cnijfilter-3.80-6-headers.patch";
